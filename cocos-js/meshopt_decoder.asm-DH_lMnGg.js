System.register(['./_virtual_cc-bifmnHB0.js'], (function (exports) {
	'use strict';
	...
	return {
		...
		execute: (function () {
			...
			var meshopt_decoder_asm$2 = {exports: {}};
			...
			} (meshopt_decoder_asm$2));

			var meshopt_decoder_asmExports = meshopt_decoder_asm$2.exports;
			var meshopt_decoder_asm = /*@__PURE__*/getDefaultExportFromCjs(meshopt_decoder_asmExports);

			var meshopt_decoder_asm$1 = /*#__PURE__*/_mergeNamespaces({
				__proto__: null,
				default: meshopt_decoder_asm
			}, [meshopt_decoder_asmExports]);
			exports("m", meshopt_decoder_asm$1);
